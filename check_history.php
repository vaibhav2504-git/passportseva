...
$query = "SELECT id, full_name, email, phone_number, aadhaar_number, status, submission_date FROM applications WHERE phone_number = ?";
...
<head>
    ...
    <title>Application History - Passport Seva</title>
    <!-- Bootstrap CSS -->
            ...
            <?php if ($user): ?>
                <div class="application-details">
                    ...
                    <div class="status-info">
                        ...
                        <span><?php echo htmlspecialchars($user['submission_date']); ?></span>
                    </div>
